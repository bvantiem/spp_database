...
f.likert.scale.by.unit.plot <- function(scale_x, plot.title){
  ...
  data_for_graph <- pcq_mf %>% filter(!is.na(unit_type), survey_wave==survey_wave_no) %>%
  ...
  p <- ggplot() + geom_bar(data=highs, aes(x = unit_type, y=value, fill=col), position="stack", stat="identity") +
    ...
    scale_fill_identity(paste0("Wave: ", i_survey_wave_no), labels = mylevels, breaks=pal, guide="legend") +
  ...
  ggsave(paste0("output/dedicated_analyses/chs_report/scale_plots/survey_wave_", survey_wave_no, "/plot_", plot.title, ".jpg"), p, width = 8, height = 4, dpi = 300)
}
...
f.likert.item.by.unit.plot <- function(item_x, plot.title){
  ...
  p <- ggplot() + geom_bar(data=highs, aes(x = unit_type, y=value, fill=col), position="stack", stat="identity") +
    geom_bar(data=lows, aes(x = unit_type, y=-value, fill=col), position="stack", stat="identity") +
    geom_hline(yintercept = 0, color =c("white")) +
    scale_fill_identity(paste0("Wave: ", i_survey_wave_no), labels = mylevels, breaks=pal[-3], guide="legend") +
    theme_fivethirtyeight() +
    coord_flip() +
    labs(title=str_to_title(gsub("_", " ", plot.title)), y="",x="") +
    theme(plot.title = element_text(size=14, hjust=0.5)) +
  ...
  ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_", survey_wave_no, "/plot_", plot.title, ".jpg"), p, width = 8, height = 3.5, dpi = 300)
}
...
f.likert.item.by.unit.plot <- function(item_x, plot.title, plot.name){
  ...
  ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_", survey_wave_no, "/plot_", plot.name, ".jpg"), p, width = 8, height = 3.5, dpi = 300)
...
my.data <- pcq2 %>% filter(survey_wave==survey_wave_no)
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_", survey_wave_no, "/plot_activities.jpg"), p, width = 8, height = 3.5, dpi = 300)
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_", survey_wave_no, "/plot_care_services.jpg"), p, width = 8, height = 3.5, dpi = 300)
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_", survey_wave_no, "/plot_visits.jpg"), p, width = 8, height = 3.5, dpi = 300)
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_", survey_wave_no, "/plot_grievances.jpg"), p, width = 8, height = 3.5, dpi = 300)
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_", survey_wave_no, "/plot_food.jpg"), p, width = 8, height = 3.5, dpi = 300)
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_", survey_wave_no, "/plot_staff.jpg"), p, width = 8, height = 3.5, dpi = 300)
