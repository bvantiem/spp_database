...
f.likert.scale.by.unit.plot <- function(scale_x, plot.title){
  ...
  p <- ggplot() +
    ...
    scale_fill_identity("Waves 1-5", labels = mylevels, breaks = pal, guide = "legend") +
  ...
  ggsave(paste0("output/dedicated_analyses/chs_report/scale_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/plot_", plot.title, ".jpg"), p, width = 10, height = 4, dpi = 300)

  write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/scale_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/data_", plot.title, ".xlsx"))
}
...
f.likert.item.by.unit.plot <- function(item_x, plot.title){
  ...
  p <- ggplot() + geom_bar(data=highs, aes(x = unit_type, y=value, fill=col), position="stack", stat="identity") +
    geom_bar(data=lows, aes(x = unit_type, y=-value, fill=col), position="stack", stat="identity") +
    geom_hline(yintercept = 0, color =c("white")) +
    scale_fill_identity("Waves 1-5", labels = mylevels, breaks=pal[-3], guide="legend") +
    theme_fivethirtyeight() +
    coord_flip() +
    labs(title=str_to_title(gsub("_", " ", plot.title)), y="",x="") +
    theme(plot.title = element_text(size=14, hjust=0.5)) +
  ...
  ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/plot_", plot.title, ".jpg"), p, width = 10, height = 3.5, dpi = 300)
}
...
f.likert.item.by.unit.plot <- function(item_x, plot.title, plot.name){
  ...
  ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/plot_", plot.name, ".jpg"), p, width = 10, height = 3.5, dpi = 300)

  write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/data_", plot.title, ".xlsx"))
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/plot_activities.jpg"), p, width = 10, height = 3.5, dpi = 300)

write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/data_activities", ".xlsx"))
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/plot_care_services.jpg"), p, width = 10, height = 3.5, dpi = 300)

write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/data_care_services", ".xlsx"))
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/plot_visits.jpg"), p, width = 10, height = 3.5, dpi = 300)

write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/data_visits", ".xlsx"))
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/plot_grievances.jpg"), p, width = 10, height = 3.5, dpi = 300)

write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/data_grievances", ".xlsx"))
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/plot_food.jpg"), p, width = 10, height = 3.5, dpi = 300)

write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/data_food", ".xlsx"))
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/plot_staff.jpg"), p, width = 10, height = 3.5, dpi = 300)

write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_rhu_gp_tc_hb_", paste(survey_wave_no, collapse = "_"), "/data_staff", ".xlsx"))
