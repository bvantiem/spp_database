...
pcq_mf <- pcq_mf %>%
  filter(unit_type %in% c("gp", "ls")) %>%
  mutate(
    unit_type = case_when(
      unit_type == "gp" ~ "General Population",
      unit_type == "ls" ~ "Little Scandinavia",
      TRUE ~ NA_character_
    )
  )
...
f.likert.scale.by.unit.plot <- function(scale_x, plot.title){
  ...
  ggsave(paste0("output/dedicated_analyses/chs_report/scale_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/plot_", plot.title, ".jpg"), p, width = 10, height = 4, dpi = 300)

  write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/scale_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/data_", plot.title, ".xlsx"))
}
...
f.likert.item.by.unit.plot <- function(item_x, plot.title){
  ...
  ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/plot_", plot.title, ".jpg"), p, width = 10, height = 3.5, dpi = 300)
}
...
f.likert.item.by.unit.plot <- function(item_x, plot.title, plot.name){
  ...
  ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/plot_", plot.name, ".jpg"), p, width = 10, height = 3.5, dpi = 300)

  write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/data_", plot.title, ".xlsx"))
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/plot_activities.jpg"), p, width = 10, height = 3.5, dpi = 300)

write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/data_activities", ".xlsx"))
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/plot_care_services.jpg"), p, width = 10, height = 3.5, dpi = 300)

write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/data_care_services", ".xlsx"))
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/plot_visits.jpg"), p, width = 10, height = 3.5, dpi = 300)

write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/data_visits", ".xlsx"))
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/plot_grievances.jpg"), p, width = 10, height = 3.5, dpi = 300)

write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/data_grievances", ".xlsx"))
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/plot_food.jpg"), p, width = 10, height = 3.5, dpi = 300)

write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/data_food", ".xlsx"))
...
ggsave(paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/plot_staff.jpg"), p, width = 10, height = 3.5, dpi = 300)

write.xlsx(data_for_graph, file = paste0("output/dedicated_analyses/chs_report/item_plots/survey_wave_ls_gp_", paste(survey_wave_no, collapse = "_"), "/data_staff", ".xlsx"))
